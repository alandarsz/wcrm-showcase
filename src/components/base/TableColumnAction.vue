<template>
  <el-table-column show-overflow-tooltip :fixed="isFixed" :min-width="minWidth">
    <template #header>
      <div class="text-center">Aksi</div>
    </template>
    <template #default="{ row }">
      <div class="table-fixed-icon">
        <el-tooltip v-if="showEdit" class="box-item" popper-class="custom-popper" effect="dark" content="Ubah" placement="top" :enterable="false">
          <el-icon class="item" @click="handleEdit(row)"><edit /></el-icon>
        </el-tooltip>
        ...
        <el-tooltip
          ...
          :enterable="false"
        >
          <el-icon class="item" @click="handleBarcode(row)"><div v-html="barcode" /></el-icon>
        </el-tooltip>
        <el-popconfirm
          v-if="showDelete"
        ...
        <el-tooltip
          ...
          :enterable="false"
        >
          <el-icon class="item" @click="handlePayment(row)"><CreditCard /></el-icon>
        </el-tooltip>
        ...
        <el-tooltip v-if="showPrint" class="box-item" popper-class="custom-popper" effect="dark" content="Print" placement="top" :enterable="false">
          <el-icon class="item" @click="handlePrint(row)"><Document /></el-icon>
        </el-tooltip>
        ...
        >
          <template #reference>
            <el-icon class="item">
              <el-tooltip class="box-item" popper-class="custom-popper" effect="dark" content="Void" placement="top" :enterable="false">
                <WarningFilled />
              </el-tooltip>
            </el-icon>
          </template>
